...
function SalesReportMonth() {
  ...
  const fetchOrders = () => {
    setProcessing(true)
    axios.get(`${baseURL}/adminapp/monthly_report/`,{
        headers: {
            ...
            <div id="salesReportDiv">
                <div className='p-10 pt-20'>
                    <div className="flex items-center justify-center pb-6">
                        <div>
                            <h1 className="text-gray-600 text-xl font-semibold">Monthly Sales Report {currentMonth}</h1>
                        </div>
                    </div>
                            ...
                            <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                                ...
                                <div className="flex items-center justify-cente p-4 bg-white rounded-lg shadow-xs ">
                                    ...
                                    <div>
                                        ...
                                        {ordersData.orders_this_month_count} 
                                        </p>
                                    </div>
                                </div>
...
export default SalesReportMonth;
