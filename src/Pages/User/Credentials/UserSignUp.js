...
const UserSignUp = () => {
  ...
  return (
    <div className="bg-white px-20">
      <div className="signup-card flex flex-col items-center justify-between pt-0 pr-10 pb-0 pl-10 mt-0 mr-auto mb-0 ml-auto max-w-7xl xl:px-5 lg:flex-row">
        <div className="flex flex-col items-center w-full pt-5 pr-10 pb-20 pl-10 lg:flex-row">
          {/* Left Section (Image) */}


          <div className="signup-image w-full bg-cover relative max-w-md lg:max-w-2xl lg:w-7/12">
          ...
          <div className="signup-card w-full mt-10 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
            <div className="flex flex-col items-start justify-start pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl relative z-10">
              ...
              {/* Form Inputs */}
              <div className="w-full mt-6 mr-0 mb-0 ml-0">
                <form onSubmit={handleFormSumbmit} method='post'>
                  ...
                  <div className="signup-card-last-text relative mt-10">
                    ...
                    <Link className="nav-link signup-card-last-text" to='/login'>
                      <span className="mt-3 signup-card-last-text text-blue-500 text-sm ml-2 hover:text-blue-500 cursor-pointer hover:-translate-y-1 duration-500 transition-all text-lg">Already Have an Account?</span>
                    </Link>
                  </div>
                </form>
              </div>
