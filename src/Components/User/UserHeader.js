...
const UserHeader = () => {
  ...
  return (
    <div>
      ...
      {/* Navbar */}
      <header className="bg-gray-100 font-sans m-0">
        <div className="bg-white shadow">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between py-4">
              <div className='ml-2 flex items-center'>
                <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-orange-500 mr-5" viewBox="0 0 24 24">
                ...
                <span className=' text-md font-semibold hover:text-orange-500 mr-4'><Link className="nav-link" to='/'>SkillBridge</Link></span>
              </div>
              ...
              <div className="hidden sm:flex sm:items-center">
                ...
                <span className="text-gray-800 text-sm font-semibold hover:text-orange-500 mr-4">About Us</span>
                <span className="text-gray-800 text-sm font-semibold hover:text-orange-500 mr-4">Help</span>
              </div>
              ...
              <div className="hidden sm:flex sm:items-center mr-5">
                ...
                {authentication_user.isAuthenticated ?
                  <>
                    <button onClick={logout} className="text-orange-500 text-sm font-semibold border-2 border-orange-500 rounded-md px-4 py-2">Logout</button>
                  </>
                  :
                  <>
                    <Link to="/login">
                      <span className="text-gray-800 text-sm font-semibold hover:text-orange-500 mr-4">Login</span>
                    </Link>
                    <Link to='/signup'>
                      <button className="text-orange-500 text-sm font-semibold border-2 border-orange-500 rounded-md px-4 py-2">Signup</button>
                    </Link>
                  </>
                }
              </div>
          ...
          <div className="bg-white shadow-sm">
            <div className="container mx-auto px-4 py-4">
              <div className="flex flex-col space-y-4">
                <Link className="nav-link" to='/course_list'>
                  <span className="text-gray-800 text-sm font-semibold hover:text-orange-500">Courses</span>
                </Link>
                <Link className="nav-link" to={`inbox/undefined/`}>
                  <span className="text-gray-800 text-sm font-semibold hover:text-orange-500">Inbox</span>
                </Link>
                <span className="text-gray-800 text-sm font-semibold hover:text-orange-500">About Us</span>
                <span className="text-gray-800 text-sm font-semibold hover:text-orange-500">Help</span>

                {(authentication_user.isAuthenticated && !authentication_user.isAdmin && !authentication_user.instructor) &&
                  <>
                    <Link className="nav-link" to='/cart'>
                      <span className="text-gray-800 text-sm font-semibold hover:text-orange-500">Cart</span>
                    </Link>
                    <Link className="nav-link" to='/wishlist'>
                      <span className="text-gray-800 text-sm font-semibold hover:text-orange-500">Wishlist</span>
                    </Link>
                  </>
                }
                ...
                {authentication_user.isAuthenticated ?
                  ...
                  <>
                    <Link to="/login">
                      <span className="text-gray-800 text-sm font-semibold hover:text-orange-500">Login</span>
                    </Link>
                    <Link to='/signup'>
                      <button className="text-orange-500 text-sm font-semibold border-2 border-orange-500 rounded-md px-4 py-2">Signup</button>
                    </Link>
