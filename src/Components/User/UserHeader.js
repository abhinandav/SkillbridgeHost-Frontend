          ...
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between py-4">
              <div className=' ml-3 sm:flex sm:items-center '>
                ...
                <span className='ml-5 text-md font-semibold hover:text-orange-500 mr-4'><Link className="nav-link" to='/'>HOME</Link></span>
              </div>
              ...
              <Link className="nav-link" to={`inbox/undefined/`}>
                ...
                {/* <span className="text-gray-800 text-sm font-semibold hover:text-orange-500">Contact</span> */}
              </div>
