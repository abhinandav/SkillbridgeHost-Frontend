...
function SalesReportYear() {
  ...
  const fetchOrders = () => {
    setProcessing(true)
    axios.get(`${baseURL}/adminapp/yearly_report/`,{
      headers: {
                ...
                <div className='flex items-center justify-center h-96'>
                  <span className="bg-indigo-400 h-max w-max rounded-lg text-white font-bold hover:bg-indigo-300 hover:cursor-not-allowed duration-[500ms,800ms]" disabled>
                    <div className="flex items-center justify-center m-[10px]">
                      ...
                      <div className="ml-2"> Processing Yearly report... </div>
                    </div>
                  </span>
                </div>
              )}
            ...
            <div id="salesReportDiv">
                <div className='p-10 pt-20'>
                    <div className="flex items-center justify-center pb-6">
                        <div>
                            <h1 className="text-gray-600 text-xl font-semibold">Yearly Sales Report {currentYear}</h1>
                        </div>
                    </div>
                            ...
                            <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                                ...
                                <div className="flex items-center justify-cente p-4 bg-white rounded-lg shadow-xs ">
                                    ...
                                    <div>
                                        ...
                                        {ordersData.orders_this_year_count} 
                                        </p>
                                    </div>
                                </div>
